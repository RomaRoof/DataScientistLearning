...
actors_df.head(15)
# Сортировка по актерам и расчет наибольшей выручки фильмов, в которых они снялись
actors_sort_df = actors_df.sort_values('revenue', ascending = False)['revenue'].head(25).plot(kind = 'bar')
