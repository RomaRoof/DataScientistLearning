...
from utils import generate_options_keyboard, get_question, new_quiz
...
def register_handlers(dp: Dispatcher):
    dp.callback_query(F.data == "right_answer")(right_answer)
    dp.callback_query(F.data == "wrong_answer")(wrong_answer)
